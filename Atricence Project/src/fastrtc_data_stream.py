...
This follows the same pattern as fastrtc_groq_voice_stream.py
from fastrtc-groq-voice-agent-main.
...
def response(
    ...
    Flow:
        ...
        2. LangGraph agent → invoke data tools (CRM, Support, Analytics)
        3. Groq TTS → convert response text to speech
        4. Yield audio chunks for FastRTC playback
    ...
    logger.debug("🧠 Running data connector agent...")
